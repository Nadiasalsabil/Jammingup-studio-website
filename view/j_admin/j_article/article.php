                      ...
                      <div class="ticket-actions col-md-2">
                        <div class="btn-group dropdown">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="dashboard.php?page=updateArticle&id='.$data->id_article.'">Update Article</a><br>
                            <a class="dropdown-item" href="dashboard.php?page=deleteArticle&id='.$data->id_article.'">Delete Article</a><br>
                          </div>
                        </div>
                      </div>
                    </div>
